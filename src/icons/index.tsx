...
export function CSVIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="m28 9l-2 13l-2-13h-2l2.516 14h2.968L30 9zM18 23h-6v-2h6v-4h-4a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h6v2h-6v4h4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2m-8 0H4a2 2 0 0 1-2-2V11a2 2 0 0 1 2-2h6v2H4v10h6z"
      ></path>
    </svg>
  )
}
